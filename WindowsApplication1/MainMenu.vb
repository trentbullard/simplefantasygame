...
Public Class MainMenu
    ...
    Private Sub MainMenu_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Each row As DataRow In GameDatabaseDataSet.Players
            playerSelectionlst.Items.Add(New player(row("id"), row("name"), row("level"), row("experience"), row("gold"), New Collection, New Collection))
        Next
    End Sub
    ...
    Private Sub playerNewbtn_Click(sender As Object, e As EventArgs) Handles playerNewbtn.Click
        ...
        playerSelectionlst.Items.Add(NewPlayer(nameString, 1, 0, -0, New Collection, New Collection))
    End Sub
    ...
    Private Function NewPlayer(name, level, experience, gold, team, inventory)
        ...
        Try
            ...
            Return New player(newRow("id"), name, level, experience, gold, New Collection, New Collection)
